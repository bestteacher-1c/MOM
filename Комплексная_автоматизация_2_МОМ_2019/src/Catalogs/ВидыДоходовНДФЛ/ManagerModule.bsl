...
Процедура СоздатьКодДохода2020() Экспорт
	
	Ставка13 = Перечисления.НДФЛСтавкиНалогообложенияРезидента.Ставка13;
	
	// АПК:1297-выкл Не локализуется, т.к. является частью регламентированной формы, применяемой в РФ.
	ОписатьКодДоходаНДФЛ("Код2763",	Ставка13, "", "Материальная помощь, оказываемая образовательной организацией студентам (курсантам), аспирантам, адъюнктам, ординаторам и ассистентам-стажерам", Истина, Истина, Справочники.ВидыВычетовНДФЛ.Код511, , , "4800");
	// АПК:1297-вкл
