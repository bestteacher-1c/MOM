...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.МедицинскиеОсмотры") Тогда
		...
		МодульМедицинскиеОсмотрыФормы.ШтатноеРасписаниеПриСозданииНаСервере(ЭтотОбъект);
	КонецЕсли;
...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.МедицинскиеОсмотры") Тогда
		МодульМедицинскиеОсмотрыФормы = ОбщегоНазначения.ОбщийМодуль("МедицинскиеОсмотрыФормы");
		МодульМедицинскиеОсмотрыФормы.ШтатноеРасписаниеОбработкаПроверкиЗаполненияНаСервере(ЭтотОбъект, Отказ, ПроверяемыеРеквизиты);
	КонецЕсли;
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.МедицинскиеОсмотры") Тогда
		МодульМедицинскиеОсмотрыФормы = ОбщегоНазначения.ОбщийМодуль("МедицинскиеОсмотрыФормы");
		МодульМедицинскиеОсмотрыФормы.ШтатноеРасписаниеПередЗаписьюНаСервере(ЭтотОбъект, Отказ, ТекущийОбъект, ПараметрыЗаписи);
	КонецЕсли;
...
Процедура ПриЗаписиНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.МедицинскиеОсмотры") Тогда
		МодульМедицинскиеОсмотрыФормы = ОбщегоНазначения.ОбщийМодуль("МедицинскиеОсмотрыФормы");
		МодульМедицинскиеОсмотрыФормы.ШтатноеРасписаниеПриЗаписиНаСервере(ЭтотОбъект, Отказ, ТекущийОбъект, ПараметрыЗаписи);
	КонецЕсли;
...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.МедицинскиеОсмотры") Тогда
		МодульМедицинскиеОсмотрыФормы = ОбщегоНазначения.ОбщийМодуль("МедицинскиеОсмотрыФормы");
		МодульМедицинскиеОсмотрыФормы.ШтатноеРасписаниеПослеЗаписиНаСервере(ЭтотОбъект, ТекущийОбъект, ПараметрыЗаписи);
	КонецЕсли;
...
Процедура КоличествоСтавокРегулирование(Элемент, Направление, СтандартнаяОбработка)
	...
	КадровыйУчетРасширенныйКлиент.КоличествоСтавокРегулирование(ЭтотОбъект, Объект.КоличествоСтавок, Направление, СтандартнаяОбработка);
...
Процедура Подключаемый_МедицинскиеОсмотрыШтатноеРасписаниеЭлементФормыПриИзменении(Элемент)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда") Тогда
		...
		МодульМедицинскиеОсмотрыФормыКлиент.ШтатноеРасписаниеЭлементПриИзменении(ЭтотОбъект, Элемент);
	КонецЕсли
...
Процедура Подключаемый_МедицинскиеОсмотрыШтатноеРасписаниеЭлементФормыПриОкончанииРедактирования(Элемент, НоваяСтрока, ОтменаРедактирования)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда") Тогда
		МодульМедицинскиеОсмотрыФормыКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("МедицинскиеОсмотрыФормыКлиент");
		МодульМедицинскиеОсмотрыФормыКлиент.ШтатноеРасписаниеЭлементПриОкончанииРедактирования(ЭтотОбъект, Элемент, НоваяСтрока, ОтменаРедактирования);
	КонецЕсли
...
Процедура Подключаемый_МедицинскиеОсмотрыШтатноеРасписаниеЭлементФормыПослеУдаления(Элемент)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда") Тогда
		МодульМедицинскиеОсмотрыФормыКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("МедицинскиеОсмотрыФормыКлиент");
		МодульМедицинскиеОсмотрыФормыКлиент.ШтатноеРасписаниеЭлементПослеУдаления(ЭтотОбъект, Элемент);
	КонецЕсли
...
Процедура НачисленияНачислениеПриИзменении(Элемент)
	...
	УправлениеШтатнымРасписаниемКлиент.НачисленияНачислениеПриИзменении(ЭтотОбъект, УправлениеШтатнымРасписаниемКлиентСервер.ДатаСобытия(ЭтотОбъект, ОбщегоНазначенияКлиент.ДатаСеанса()), Объект.РазрядКатегория, Объект.ТарифнаяСетка, 
...
Процедура Подключаемый_ОбработчикКоманды(Команда)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда") Тогда
		МодульМедицинскиеОсмотрыФормыКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("МедицинскиеОсмотрыФормыКлиент");
		МодульМедицинскиеОсмотрыФормыКлиент.ШтатноеРасписаниеПриВыполненииКоманды(ЭтотОбъект, Команда);
	КонецЕсли
...
Процедура ДополнитьФорму()
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.МедицинскиеОсмотры") Тогда
		МодульМедицинскиеОсмотрыФормы = ОбщегоНазначения.ОбщийМодуль("МедицинскиеОсмотрыФормы");
		МодульМедицинскиеОсмотрыФормы.ШтатноеРасписаниеПриДополненииФормы(ЭтотОбъект);
	КонецЕсли;
...
Процедура ПоместитьДанныеОбъектаВФорму(ТекущийОбъект, ЗначениеКопирования = Неопределено)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.МедицинскиеОсмотры") Тогда
		МодульМедицинскиеОсмотрыФормы = ОбщегоНазначения.ОбщийМодуль("МедицинскиеОсмотрыФормы");
		МодульМедицинскиеОсмотрыФормы.ШтатноеРасписаниеПриЧтенииНаСервере(ЭтотОбъект, ТекущийОбъект);
	КонецЕсли;
...
Процедура УстановитьДоступностьЭлементов(Форма)
	...
	Если ОбщегоНазначенияБЗККлиентСервер.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда") Тогда
		...
		МодульОхранаТрудаКлиентСервер.УстановитьДоступностьЭлементовФормыПозицииШтатногоРасписания(Форма);
	КонецЕсли;
...
Процедура МедицинскиеОсмотрыЭлементФормыПриОкончанииРедактированияНаСервере(ИмяЭлемента, ДополнительныеПараметры)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.МедицинскиеОсмотры") Тогда
		МодульМедицинскиеОсмотрыФормы = ОбщегоНазначения.ОбщийМодуль("МедицинскиеОсмотрыФормы");
		МодульМедицинскиеОсмотрыФормы.ШтатноеРасписаниеЭлементПриОкончанииРедактирования(ЭтотОбъект, ИмяЭлемента, ДополнительныеПараметры);
	КонецЕсли
...
Процедура МедицинскиеОсмотрыЭлементФормыПослеУдаленияНаСервере(ИмяЭлемента, ДополнительныеПараметры)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.МедицинскиеОсмотры") Тогда
		МодульМедицинскиеОсмотрыФормы = ОбщегоНазначения.ОбщийМодуль("МедицинскиеОсмотрыФормы");
		МодульМедицинскиеОсмотрыФормы.ШтатноеРасписаниеЭлементПослеУдаления(ЭтотОбъект, ИмяЭлемента, ДополнительныеПараметры);
	КонецЕсли
...
Процедура МедицинскиеОсмотрыОбработкаКомандыНаСервере(Результат, ДополнительныеПараметры)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.МедицинскиеОсмотры") Тогда
		МодульМедицинскиеОсмотрыФормы = ОбщегоНазначения.ОбщийМодуль("МедицинскиеОсмотрыФормы");
		МодульМедицинскиеОсмотрыФормы.ШтатноеРасписаниеПриВыполненииКоманды(ЭтотОбъект, Результат, ДополнительныеПараметры);
	КонецЕсли
