...
Процедура ПроинициализироватьФорму()
	...
	ВидимостьРеквизитаСтудентРаботающийВСтудотряде = ИзФормыСотрудника;
	ТолькоПросмотрРеквизитаСтудентРаботающийВСтудотряде = Ложь;
	Если ВидимостьРеквизитаСтудентРаботающийВСтудотряде Тогда
		...
		Если СотрудникиФизическогоЛица.НайтиСтроки(Новый Структура("Сотрудник,ОформленПоТрудовомуДоговору", СотрудникСсылка,Истина)).Количество() > 0 Тогда
			ВидимостьРеквизитаСтудентРаботающийВСтудотряде = СтудентРаботающийВСтудотряде;
			ТолькоПросмотрРеквизитаСтудентРаботающийВСтудотряде = Истина; 
		КонецЕсли;
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		...
		"Видимость",
		ВидимостьРеквизитаСтудентРаботающийВСтудотряде);
	
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы,
		"СтудентРаботающийВСтудотряде",
		"ТолькоПросмотр",
		ТолькоПросмотрРеквизитаСтудентРаботающийВСтудотряде);
