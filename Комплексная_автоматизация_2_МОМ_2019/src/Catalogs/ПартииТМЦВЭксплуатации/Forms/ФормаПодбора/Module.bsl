...
Функция ТекстЗапросаДинамическогоСписка()
	...
	//++ НЕ УТ
	|	СправочникПартий.СпособПогашенияСтоимостиБУ,
	//-- НЕ УТ
	|	СправочникПартий.ДатаЗавершенияЭксплуатации,
	|	ВложенныйЗапрос.КоличествоОборот КАК Количество,
	|	ВЫБОР
	//++ НЕ УТ
	|		КОГДА СправочникПартий.СпособПогашенияСтоимостиБУ = ЗНАЧЕНИЕ(Перечисление.СпособыПогашенияСтоимостиТМЦ.ПоНаработке)
	...
	//++ НЕ УТ
	|				И СправочникПартий.СпособПогашенияСтоимостиБУ <> ЗНАЧЕНИЕ(Перечисление.СпособыПогашенияСтоимостиТМЦ.ПоНаработке)
	//-- НЕ УТ
	|			ТОГДА ИСТИНА
	|		ИНАЧЕ ЛОЖЬ
	...
	|		
	//++ НЕ УТ
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.НаработкиТМЦВЭксплуатации.СрезПоследних(&Дата, ) КАК Наработки
	|		ПО СправочникПартий.ИнвентарныйНомер = Наработки.ИнвентарныйНомер
	//-- НЕ УТ
	|		
	|ГДЕ
