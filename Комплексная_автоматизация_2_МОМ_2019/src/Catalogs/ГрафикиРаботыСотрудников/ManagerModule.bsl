...
Функция ЗапросДляПечатиГрафиков(МассивОбъектов, Год)
	...
	|ВЫБРАТЬ
	|	СУММА(ВЫБОР
	|			КОГДА ДанныеПроизводственногоКалендаря.Дата МЕЖДУ &ДатаНачалаОплатыНерабочих И &ДатаОкончанияОплатыНерабочих
	|				ТОГДА 0
	...
	|					ИЛИ ДанныеПроизводственногоКалендаря.Дата МЕЖДУ &ДатаНачалаОплатыНерабочих И &ДатаОкончанияОплатыНерабочих
	|				ТОГДА 1
	|			ИНАЧЕ 0
