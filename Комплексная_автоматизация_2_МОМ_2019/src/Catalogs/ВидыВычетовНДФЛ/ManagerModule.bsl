...
Процедура ЗаполнитьКодыВычетовНДФЛ() Экспорт
	...
	,,
	"509","509","509","509");
	ОписатьКодВычетаНДФЛ("Код511", "511", "Вычет из суммы материальной помощи, оказываемой образовательной организацией студентам (курсантам), аспирантам, адъюнктам, ординаторам и ассистентам-стажерам",
	,,
	"-","-","-","620");
