	...
	ИначеЕсли ЭтоПередачаТоваров(Объект.ВариантОформленияДокументов) Тогда
		...
		Если Объект.Товары.Количество() = 0 Тогда
			Если Объект.ВариантОформленияДокументов = Перечисления.ВариантыОформленияДокументовПродажи.ЗаказКлиентаПередачаТоваровХранителю Тогда
				ДобавитьТекстНадписиВМассив(МассивНадписей, НСтр("ru='Заказ'"), "%СуммаЗаказа%", СуммаЗаказа, Ложь);
			Иначе
				ДобавитьТекстНадписиВМассив(МассивНадписей, НСтр("ru='Передача'"), "%СуммаПередачи%", СуммаЗаказа, Ложь);
			КонецЕсли;
		КонецЕсли;
		...
		Если ТребуетсяОформлениеПередачи Тогда
			ДобавитьТекстНадписиВМассив(МассивНадписей, НСтр("ru='Передача'"), "%СуммаПередачи%", СуммаПередачи, Ложь);
		КонецЕсли;
