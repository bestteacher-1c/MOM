...
Процедура Выгрузить(Команда)
	...
	Если Элементы.ЖурналОтчетов.ТекущиеДанные.НаименованиеОтчета = "Расчет совокупного размера прибыли"
...
Процедура ПоказатьСДвухмернымШтрихкодомPDF417(Команда)
	...
	Если Элементы.ЖурналОтчетов.ТекущиеДанные.НаименованиеОтчета = "Расчет совокупного размера прибыли" Тогда
		ПоказатьПредупреждение(, НСтр(
