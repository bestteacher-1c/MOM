...
Процедура Подключаемый_Напечатать(Команда)
	...
	ОбъектыПечати = ОбъектыПечати(ПоказыватьФинансирование);
...
&НаСервере
Функция ОбъектыПечати(ДетальноПоФинансированию)
	...
	ОбъектыПечати.Добавить(Объект.Организации[0]);
	ОбъектыПечати.Добавить(Объект.МесяцНачисления);
	ОбъектыПечати.Добавить(ПоляФинансирования);
	ОбъектыПечати.Добавить(ДанныеДляОтчета);
