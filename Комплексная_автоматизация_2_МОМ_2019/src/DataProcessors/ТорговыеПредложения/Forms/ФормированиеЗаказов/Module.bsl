...
&НаСервереБезКонтекста
Функция ПолучитьЗарегистрированныеОрганизации()
	...
	Запрос = Новый Запрос("ВЫБРАТЬ РАЗЛИЧНЫЕ
	                      ...
	                      |
	                      |УПОРЯДОЧИТЬ ПО
	                      |	ОрганизацииБизнесСеть.Организация.Представление");
...
Процедура ОрганизацияНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	Элементы.Организация.СписокВыбора.ЗагрузитьЗначения(ПолучитьЗарегистрированныеОрганизации());
КонецПроцедуры
