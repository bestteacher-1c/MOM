...
&НаКлиенте
Процедура ОткрытьФормуРедактированияДанныхПервичногоДокумента(ИдентификаторыСтрок = Неопределено)
	...
	ОткрытьФорму(
		"Документ.ВозвратВОборотИСМП.Форма.ЗаполнениеПервичногоДокумента",
		ПараметрыОткрытия, ЭтотОбъект,,,,
		ОписаниеОповещения);
