...
Процедура УстановитьВидимостьДоступностьЭлементов()
	...
	Иначе
		УчетнаяПолитикаЗаголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			Нстр("ru = 'Порядок оценки задолженности определяется учетной политикой ""%1"" организации'"), УчетнаяПолитикаТекущая);
	КонецЕсли;
...
Функция ЗаполнитьТекущиеДанныеДЗ()
	...
	Результат = Новый Структура(
		"ВидЗадолженности,Контрагент,Договор,РасчетныйДокумент,ТипСуммы," +
