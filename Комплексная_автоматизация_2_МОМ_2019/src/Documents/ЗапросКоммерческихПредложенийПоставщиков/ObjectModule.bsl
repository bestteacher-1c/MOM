...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ИмяТабличнойЧасти  = НСтр("ru = 'Товары'");
	
	МассивНепроверяемыхРеквизитов = Новый Массив;
	МассивНепроверяемыхРеквизитов.Добавить(ИмяТабличнойЧасти + ".Номенклатура" );
	МассивНепроверяемыхРеквизитов.Добавить(ИмяТабличнойЧасти + ".НоменклатураВСервисеПредставление" );
	МассивНепроверяемыхРеквизитов.Добавить(ИмяТабличнойЧасти + ".НоменклатураТекстом" );
	МассивНепроверяемыхРеквизитов.Добавить(ИмяТабличнойЧасти + ".КатегорияВСервисеПредставление");
