...
Процедура РегистрацияВНалоговомОрганеПриИзмененииНаСервере()
	...
	Если Не Объект.ФиксНалоги Тогда
		...
		УчетНДФЛДокументы.СправкиНДФЛПрочитатьДанные(ДанныеСправок, ПараметрыСправокНДФЛ, Не ДокументПроведен);
...
Процедура ОбновитьНалогиНаСервере()
	...
	УчетНДФЛФормы.СправкиНДФЛОбновитьНалоги(Объект, ПараметрыСправокНДФЛ);	
...
Процедура ЗаполнитьДанныеСправкиНаСервере()
	...
	УчетНДФЛДокументы.СправкиНДФЛПрочитатьДанные(ДанныеСправок, ПараметрыСправокНДФЛ, Истина);
...
Процедура ПрочитатьДанныеСправки()
	...
	Если Не ВнешниеДанные Тогда
		...
		УчетНДФЛДокументы.СправкиНДФЛПрочитатьДанныеСотрудников(
		ДанныеСправок, 
		Объект.НалоговыйПериод, 
