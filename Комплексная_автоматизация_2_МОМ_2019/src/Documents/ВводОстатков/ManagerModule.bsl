...
Функция ОстаткиПоТипуОперации(Дата, ТипОперации, МассивОрганизаций, ДополнительныйОтбор = Неопределено, ПараметрыЗаполненияОстатков = Неопределено) Экспорт
	...
	ИначеЕсли ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиСобственныхТоваров
		...
		Возврат ОстаткиПоТоварам(ДатаОстатков, ТипОперации, МассивОрганизаций, ДополнительныйОтбор, ПараметрыЗаполненияОстатков);
	ИначеЕсли ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиЗадолженностиПодотчетников
		ИЛИ ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ПерерасходыПодотчетныхСредств Тогда
...
Функция ОстаткиПоТоварам(ДатаОстатков, ТипОперации, МассивОрганизаций, ДопОтбор, ПараметрыЗаполненияОстатков)
	
	Запрос = Новый ПостроительЗапроса;
	
	Если НЕ ЗначениеЗаполнено(ПараметрыЗаполненияОстатков) ИЛИ НЕ ПараметрыЗаполненияОстатков.Свойство("ОтражатьСебестоимость") Тогда
