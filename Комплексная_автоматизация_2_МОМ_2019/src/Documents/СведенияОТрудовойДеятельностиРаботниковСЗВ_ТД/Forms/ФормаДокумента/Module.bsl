...
Процедура ЗаполнитьНаСервере(ЗаполнитьВсемиСотрудниками)
	...
	ПеренестиДанныеТрудовойДеятельностиСотрудниковВДокумент(ЭлектронныеТрудовыеКнижки.ДанныеТрудовойДеятельностиСотрудниковОрганизации(
		Истина, Объект.Организация, ЭлектронныеТрудовыеКнижки.ДатаНачалаУчета(), Мин(КонецМесяца(Объект.ОтчетныйПериод), Объект.Дата), ЗаполнитьВсемиСотрудниками, Объект.Ссылка),
...
Процедура ЗаполнитьДанныеСотрудников(СписокСотрудников, ЗаполнитьВсемиСотрудниками = Ложь)
	...
	ПеренестиДанныеТрудовойДеятельностиСотрудниковВДокумент(ЭлектронныеТрудовыеКнижки.ДанныеТрудовойДеятельностиСотрудников(
		Истина, СписокСотрудников, Объект.Организация, Объект.ОтчетныйПериод, КонецМесяца(Объект.ОтчетныйПериод), ЗаполнитьВсемиСотрудниками), ЗаполнитьВсемиСотрудниками);
...
Процедура СотрудникиСотрудникПриИзмененииНаСервере()
	...
	ДанныеЗаполнения = ЭлектронныеТрудовыеКнижки.ДанныеТрудовойДеятельностиСотрудников(
		Истина, СписокСотрудников, Объект.Организация, Объект.ОтчетныйПериод, Мин(КонецМесяца(Объект.ОтчетныйПериод), Объект.Дата), , Объект.Ссылка);
