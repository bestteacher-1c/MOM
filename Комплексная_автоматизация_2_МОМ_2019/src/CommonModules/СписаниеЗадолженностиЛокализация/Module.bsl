...
Функция ТекстЗапросаВТОтраженияВРеглУчете() Экспорт
	...
	|	ВЫБОР КОГДА Аналитика.Организация = Расчеты.ЗаказКлиента.Организация
	...
	|	ВЫБОР КОГДА Расчеты.Организация = Расчеты.ОбъектРасчетов.Организация
	|		ТОГДА ЕСТЬNULL(Расчеты.ГруппаФинансовогоУчета, ЗНАЧЕНИЕ(Справочник.ГруппыФинансовогоУчетаРасчетов.ПустаяСсылка))
	|		ИНАЧЕ ЕСТЬNULL(Расчеты.ГруппаФинансовогоУчетаПолучателя, ЗНАЧЕНИЕ(Справочник.ГруппыФинансовогоУчетаРасчетов.ПустаяСсылка))
	|	КОНЕЦ КАК ГруппаФинансовогоУчета,
	...
	|	ВЫБОР КОГДА Аналитика.Организация = Расчеты.ЗаказПоставщику.Организация
