	...
	Для Каждого КлючИЗначение Из Структура Цикл
		...
		Для Каждого ЭлементОтбора Из Отборы Цикл
			...
			Если Используется Тогда
				...
				Иначе
					...
					Иначе
						РодительскиеЭлементыОтборы = ЭлементОтбора.Родитель.Элементы;
					КонецЕсли;
		...
		Если Используется Тогда
			...
			Для Каждого ЭлементОтбора Из НеНастраиваемыеОтборы Цикл
				...
				Иначе
					НовыйЭлементОтбора = ЭлементОтбора.Родитель.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
				КонецЕсли;
