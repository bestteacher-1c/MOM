...
Функция ОписаниеВидаТарифа(ТарифСтраховыхВзносов) Экспорт
	...
	ИначеЕсли ТарифСтраховыхВзносов = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ДляСубъектовМалогоПредпринимательства") Тогда
		ОписаниеТарифа = "Тариф установлен с апреля 2020 года для страхователей, удовлетворяющих условиям подпункта 17 пункта 1 статьи 427 НК РФ"
	ИначеЕсли ТарифСтраховыхВзносов = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ДляОтраслейПострадавшихОтКоронавируснойИнфекции") Тогда
		ОписаниеТарифа = "Тариф установлен в отношении выплат, начисленных за апрель-июнь 2020 года, для организаций, занятых в сферах деятельности, наиболее пострадавших в условиях ухудшения ситуации в связи с распространением коронавирусной инфекции."
