...
Функция ПостроитьДеревоОператоров(УсловиеДляЗапроса = Истина) Экспорт
	...
	Если УсловиеДляЗапроса Тогда
		РаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, НСтр("ru = 'Условие'"), НСтр("ru = 'ВЫБОР КОГДА <Условие> ТОГДА <РезультатИстина> ИНАЧЕ <РезультатЛожь> КОНЕЦ'"), 3);
	Иначе
		РаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, НСтр("ru = 'Условие'"), НСтр("ru = '?(<Условие>, <РезультатИстина>, <РезультатЛожь>)'"), 3);
	КонецЕсли;
