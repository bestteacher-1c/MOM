...
Процедура ЗаполнитьСотрудниковПерерасчетаДокумента(Объект) Экспорт
	...
	ТаблицаСотрудников = ПустаяТаблицаСотрудникиПериодДействияПерерасчет();
	...
	ТаблицаСотрудников.Свернуть("Сотрудник,ФизическоеЛицо,ПериодДействия,ВидРасчета,ДокументОснование,ПерерасчетНачислений,ПерерасчетУдержаний");
