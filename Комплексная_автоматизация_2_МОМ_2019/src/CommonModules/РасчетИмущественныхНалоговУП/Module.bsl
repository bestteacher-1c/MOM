...
Функция ПустаяТаблицаРасходыНаПлатон()
	...
	РасходыНаПлатон.Колонки.Добавить("СуммаНУДт", ОбщегоНазначения.ОписаниеТипаЧисло(15, 2));
	РасходыНаПлатон.Колонки.Добавить("СуммаНУКт", ОбщегоНазначения.ОписаниеТипаЧисло(15, 2));
...
Функция ПодготовитьТаблицыРасчетНалога(ТаблицаРеквизиты, Отказ, ДополнительныеПараметры = Неопределено) Экспорт
	...
	ТаблицыРасчетНалога = ТаблицыРасчетНалога(Реквизиты, ДополнительныеПараметры.СписокОшибок);
...
Функция ТаблицыРасчетНалога(Реквизиты, СписокОшибок)
	...
	ИначеЕсли Реквизиты.ВидНалога = Перечисления.ВидыИмущественныхНалогов.ТранспортныйНалог Тогда
		...
		ПроверитьРасчетТранспортногоНалога(РасчетыПоНалогу, СписокОшибок);
