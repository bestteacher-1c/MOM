...
Процедура УстановитьФункциональныеОпцииИспользованияЗарплатыИКадров() Экспорт
	...
	Если ИспользоватьНачислениеЗарплаты <> ИспользоватьКадровыйУчет Тогда
		Константы.ИспользоватьКадровыйУчет.Установить(ИспользоватьНачислениеЗарплаты);
	КонецЕсли;
	// Конец
