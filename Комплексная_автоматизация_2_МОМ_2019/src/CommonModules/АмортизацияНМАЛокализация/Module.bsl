...
Процедура ТекстЗапросаРасчетАмортизации_БУ(СписокЗапросов, ПараметрыРасчета)
	...
	|			ИНАЧЕ &СуммаБУ
	|		КОНЕЦ";
	ТекстПоля = СтрЗаменить(ТекстПоля, "&СуммаБУ", "СУММА(СписокНМА.СуммаБУ - ВЫРАЗИТЬ(СписокНМА.СуммаБУ * СписокНМА.КоэффициентЦФБУ КАК ЧИСЛО (15,2)))");
	...
	|			ИНАЧЕ &СуммаНУ
	|		КОНЕЦ";
	ТекстПоля = СтрЗаменить(ТекстПоля, "&СуммаНУ", "СУММА(СписокНМА.СуммаНУ - ВЫРАЗИТЬ(СписокНМА.СуммаНУ * СписокНМА.КоэффициентЦФНУ КАК ЧИСЛО (15,2)))");
	...
	|			ИНАЧЕ &СуммаПР
	|		КОНЕЦ";
	ТекстПоля = СтрЗаменить(ТекстПоля, "&СуммаПР", "СУММА(СписокНМА.СуммаПР - ВЫРАЗИТЬ(СписокНМА.СуммаПР * СписокНМА.КоэффициентЦФПР КАК ЧИСЛО (15,2)))");
	...
	|			ИНАЧЕ &СуммаЦФ
	|		КОНЕЦ";
	ТекстПоля = СтрЗаменить(ТекстПоля, "&СуммаЦФ", "СУММА(ВЫРАЗИТЬ(СписокНМА.СуммаБУ * СписокНМА.КоэффициентЦФБУ КАК ЧИСЛО (15,2)))");
	...
	|			ИНАЧЕ &СуммаНУЦФ
	|		КОНЕЦ";
	ТекстПоля = СтрЗаменить(ТекстПоля, "&СуммаНУЦФ", "СУММА(ВЫРАЗИТЬ(СписокНМА.СуммаНУ * СписокНМА.КоэффициентЦФНУ КАК ЧИСЛО (15,2)))");
	...
	|			ИНАЧЕ &СуммаПРЦФ
	|		КОНЕЦ";
	ТекстПоля = СтрЗаменить(ТекстПоля, "&СуммаПРЦФ", "СУММА(ВЫРАЗИТЬ(СписокНМА.СуммаПР * СписокНМА.КоэффициентЦФПР КАК ЧИСЛО (15,2)))");
