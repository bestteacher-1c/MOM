...
Функция ОбработкаДействияСАлкоОтчетом(ОписаниеОтчета, Действие,
	...
	Алко27.ФормаОтчета2019Кв1.Вставить("НачалоДействия", "4 квартал 2019 года");
	...
	Алко28.ФормаОтчета2019Кв1.Вставить("НачалоДействия", "4 квартал 2019 года");
	...
	Алко29.ФормаОтчета2019Кв1.Вставить("НачалоДействия", "4 квартал 2019 года");
	...
	Алко30.Вставить("ФормаОтчета2019Кв4", Новый Структура);
	Алко30.ФормаОтчета2019Кв4.Вставить("ТабличныйОтчет", Ложь);
	Алко30.ФормаОтчета2019Кв4.Вставить("Утверждена", "Постановлением Правительства РФ от 20.04.2019 № 472");
	Алко30.ФормаОтчета2019Кв4.Вставить("НачалоДействия", "4 квартал 2019 года");
	УстановитьДляФормыДействие(СписокДействий, Алко30.ФормаОтчета2019Кв4, Неопределено, Истина);
	УстановитьДляФормыДействие(СписокДействий, Алко30.ФормаОтчета2019Кв4, "ЗагрузкаИзФайла", Ложь);
	
	// Формы Алко31. Фармацевтические.
	Алко31 = СтруктураАлкоОтчетов.РегламентированныйОтчетАлкоПриложение31;

	Алко31.Вставить("ФормаОтчета2019Кв4", Новый Структура);
	Алко31.ФормаОтчета2019Кв4.Вставить("ТабличныйОтчет", Ложь);
	Алко31.ФормаОтчета2019Кв4.Вставить("Утверждена", "Постановлением Правительства РФ от 20.04.2019 № 472");
	Алко31.ФормаОтчета2019Кв4.Вставить("НачалоДействия", "4 квартал 2019 года");
	УстановитьДляФормыДействие(СписокДействий, Алко31.ФормаОтчета2019Кв4, Неопределено, Истина);
	УстановитьДляФормыДействие(СписокДействий, Алко31.ФормаОтчета2019Кв4, "ЗагрузкаИзФайла", Ложь);
	
	// Формы Алко32. Фармацевтические.
	Алко32 = СтруктураАлкоОтчетов.РегламентированныйОтчетАлкоПриложение32;

	Алко32.Вставить("ФормаОтчета2019Кв4", Новый Структура);
	Алко32.ФормаОтчета2019Кв4.Вставить("ТабличныйОтчет", Ложь);
	Алко32.ФормаОтчета2019Кв4.Вставить("Утверждена", "Постановлением Правительства РФ от 20.04.2019 № 472");
	Алко32.ФормаОтчета2019Кв4.Вставить("НачалоДействия", "4 квартал 2019 года");
	УстановитьДляФормыДействие(СписокДействий, Алко32.ФормаОтчета2019Кв4, Неопределено, Истина);
	УстановитьДляФормыДействие(СписокДействий, Алко32.ФормаОтчета2019Кв4, "ЗагрузкаИзФайла", Ложь);
	
	// Формы Алко33. Фармацевтические.
	Алко33 = СтруктураАлкоОтчетов.РегламентированныйОтчетАлкоПриложение33;

	Алко33.Вставить("ФормаОтчета2019Кв4", Новый Структура);
	Алко33.ФормаОтчета2019Кв4.Вставить("ТабличныйОтчет", Ложь);
	Алко33.ФормаОтчета2019Кв4.Вставить("Утверждена", "Постановлением Правительства РФ от 20.04.2019 № 472");
	Алко33.ФормаОтчета2019Кв4.Вставить("НачалоДействия", "4 квартал 2019 года");
	УстановитьДляФормыДействие(СписокДействий, Алко33.ФормаОтчета2019Кв4, Неопределено, Истина);
	УстановитьДляФормыДействие(СписокДействий, Алко33.ФормаОтчета2019Кв4, "ЗагрузкаИзФайла", Ложь);
	
	// Формы Алко34. Фармацевтические.
	Алко34 = СтруктураАлкоОтчетов.РегламентированныйОтчетАлкоПриложение34;

	Алко34.Вставить("ФормаОтчета2019Кв4", Новый Структура);
	Алко34.ФормаОтчета2019Кв4.Вставить("ТабличныйОтчет", Ложь);
	Алко34.ФормаОтчета2019Кв4.Вставить("Утверждена", "Постановлением Правительства РФ от 20.04.2019 № 472");
	Алко34.ФормаОтчета2019Кв4.Вставить("НачалоДействия", "4 квартал 2019 года");
	УстановитьДляФормыДействие(СписокДействий, Алко34.ФормаОтчета2019Кв4, Неопределено, Истина);
	УстановитьДляФормыДействие(СписокДействий, Алко34.ФормаОтчета2019Кв4, "ЗагрузкаИзФайла", Ложь);
	
	// Формы Алко35. Фармацевтические.
	Алко35 = СтруктураАлкоОтчетов.РегламентированныйОтчетАлкоПриложение35;

	Алко35.Вставить("ФормаОтчета2019Кв4", Новый Структура);
	Алко35.ФормаОтчета2019Кв4.Вставить("ТабличныйОтчет", Ложь);
	Алко35.ФормаОтчета2019Кв4.Вставить("Утверждена", "Постановлением Правительства РФ от 20.04.2019 № 472");
	Алко35.ФормаОтчета2019Кв4.Вставить("НачалоДействия", "4 квартал 2019 года");
	УстановитьДляФормыДействие(СписокДействий, Алко35.ФормаОтчета2019Кв4, Неопределено, Истина);
	УстановитьДляФормыДействие(СписокДействий, Алко35.ФормаОтчета2019Кв4, "ЗагрузкаИзФайла", Ложь);
	
	// Формы Алко36. Фармацевтические.
	Алко36 = СтруктураАлкоОтчетов.РегламентированныйОтчетАлкоПриложение36;

	Алко36.Вставить("ФормаОтчета2019Кв4", Новый Структура);
	Алко36.ФормаОтчета2019Кв4.Вставить("ТабличныйОтчет", Ложь);
	Алко36.ФормаОтчета2019Кв4.Вставить("Утверждена", "Постановлением Правительства РФ от 20.04.2019 № 472");
	Алко36.ФормаОтчета2019Кв4.Вставить("НачалоДействия", "4 квартал 2019 года");
	УстановитьДляФормыДействие(СписокДействий, Алко36.ФормаОтчета2019Кв4, Неопределено, Истина);
	УстановитьДляФормыДействие(СписокДействий, Алко36.ФормаОтчета2019Кв4, "ЗагрузкаИзФайла", Ложь);
	
	// Формы Алко37. Фармацевтические.
	Алко37 = СтруктураАлкоОтчетов.РегламентированныйОтчетАлкоПриложение37;

	Алко37.Вставить("ФормаОтчета2019Кв4", Новый Структура);
	Алко37.ФормаОтчета2019Кв4.Вставить("ТабличныйОтчет", Ложь);
	Алко37.ФормаОтчета2019Кв4.Вставить("Утверждена", "Постановлением Правительства РФ от 20.04.2019 № 472");
	Алко37.ФормаОтчета2019Кв4.Вставить("НачалоДействия", "4 квартал 2019 года");
	УстановитьДляФормыДействие(СписокДействий, Алко37.ФормаОтчета2019Кв4, Неопределено, Истина);
	УстановитьДляФормыДействие(СписокДействий, Алко37.ФормаОтчета2019Кв4, "ЗагрузкаИзФайла", Ложь);
