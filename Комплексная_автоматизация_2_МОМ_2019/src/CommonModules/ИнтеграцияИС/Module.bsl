...
Функция ПараметрыЗаполненияТабличнойЧастиТовары(ВидыПродукции) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ГосИС.ИСМП") Тогда
		...
		ТребуетсяДополнитьПараметрыИСМП = Ложь;
		Для Каждого ВидПродукцииИСМП Из ИнтеграцияИСКлиентСервер.ВидыПродукцииИСМП(Истина) Цикл
			ТребуетсяДополнитьПараметрыИСМП = ТребуетсяДополнитьПараметрыИСМП Или ВидыПродукции.Найти(ВидПродукцииИСМП) <> Неопределено;
		КонецЦикла;
		
		Если ТребуетсяДополнитьПараметрыИСМП Тогда
...
Функция ПредставлениеСоставаУпаковки(НоменклатураУпаковки) Экспорт
	...
	Для Каждого ЭлементМассива Из НоменклатураУпаковки Цикл
	...
	НаименованияНоменклатурыУпаковки = ОбщегоНазначения.ЗначениеРеквизитаОбъектов(МассивСсылок, "Наименование");
	
	Для Каждого ЭлементМассива Из МассивСтрок Цикл
		НаименованияНоменклатурыУпаковки.Вставить(ЭлементМассива, ЭлементМассива);
	КонецЦикла;
...
//
Функция ПоляПоискаМаркируемойПродукции(ЕстьСерии = Истина, ЕстьGTIN = Ложь, ЕстьМолочнаяПродукция = Ложь) Экспорт
	...
	Если ЕстьМолочнаяПродукция Тогда
