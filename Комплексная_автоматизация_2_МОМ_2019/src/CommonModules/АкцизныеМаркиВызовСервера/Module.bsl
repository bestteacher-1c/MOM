...
Процедура ЗаполнитьСопоставленнуюНоменклатуруПоАкцизнойМарке(Штрихкод, ДанныеШтрихкода, КэшКодовАлкогольнойПродукции = Неопределено) Экспорт
	...
	СписокЗапросов.Добавить(ШтрихкодированиеИС.ОпределитьТекстЗапросаСвойстваМаркируемойПродукции());
	...
	Если ВыборкаВсеСопоставление.Количество() = 1 Тогда
		...
		ДанныеШтрихкода.МаркируемаяПродукция    = ВыборкаВсеСопоставление.МаркируемаяПродукция;
	...
	ИначеЕсли ВыборкаТолькоНоменклатура.Количество() = 1 Тогда
		...
		ДанныеШтрихкода.МаркируемаяПродукция    = ВыборкаТолькоНоменклатура.МаркируемаяПродукция;
