...
// Получает сумму НДС к уплате за налоговый период по данным декларации НДС
//
// Параметры:
//
//     Организация - СправочникСсылка.Организации - организация, по которой нужно получить данные декларации.
//     ГруппаОрганизаций - Массив значений типа СправочникСсылка.Организации - организации, по которым нужно получить данные декларации.
//     НачалоПериода - Дата - начало налогового периода.
//     КонецПериода - Дата - конец налогового периода.
//
// Результат представляет собой структуру с полями типа Число(19,2):
//     ВычетПоЭкспорту
//     НачислениеПоЭкспорту
//     КУплате
//     КВозмещению
//
