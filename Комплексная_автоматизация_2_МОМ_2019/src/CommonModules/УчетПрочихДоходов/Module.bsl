...
Процедура РезультатРасчетаВДанныеФормы(Форма, ДанныеРасчета) Экспорт
	...
	// НДФЛ
	РасчетЗарплатыРасширенныйФормы.РасчетЗарплатыНДФЛКонтрагентовВДанныеФормы(Объект.НДФЛ, Объект.ПримененныеВычетыНаДетейИИмущественные, ДанныеРасчета.НДФЛ);
...
Функция СведенияОДоходахНДФЛДокумента(Объект, ФизическоеЛицо) Экспорт
	...
	ДатаОперацииПоНалогам = УчетНДФЛРасширенный.ДатаОперацииПоДокументу(Объект.Дата, Объект.ПериодРегистрации);
...
Процедура ПровестиПоУчетам(Объект, Отказ) Экспорт
	...
	// НДФЛ
	ДатаОперацииПоНалогам = УчетНДФЛРасширенный.ДатаОперацииПоДокументу(Объект.ПланируемаяДатаВыплаты, Объект.ПериодРегистрации);
