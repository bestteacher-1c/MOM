...
Функция ПолучитьСведенияОПоказателяхОтчета(ИДОтчета, ИДРедакцииОтчета, ПараметрыОтчета = Неопределено) Экспорт
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетПрибыль" Тогда
		...
		Если ИДРедакцииОтчета = "ФормаОтчета2015Кв1" ИЛИ ИДРедакцииОтчета = "ФормаОтчета2016Кв4" ИЛИ ИДРедакцииОтчета = "ФормаОтчета2019Кв4" Тогда
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетИмущество" Тогда
		...
		ИначеЕсли ИДРедакцииОтчета = "ФормаОтчета2019Кв1" ИЛИ ИДРедакцииОтчета = "ФормаОтчета2019Кв4" Тогда
			
			РегламентированнаяОтчетностьУП.ПолучитьСведенияОПоказателяхОтчетаИмуществоФормаОтчета2019(ПоказателиОтчета, ИДРедакцииОтчета);
...
Процедура ЗаполнитьОтчет(ИДОтчета, ИДРедакцииОтчета, ПараметрыОтчета, Контейнер) Экспорт
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетИмущество" Тогда
		...
		ИначеЕсли ИДРедакцииОтчета = "ФормаОтчета2019Кв1" ИЛИ ИДРедакцииОтчета = "ФормаОтчета2019Кв4" Тогда
			...
			РегламентированнаяОтчетностьУП.ЗаполнитьОтчетИмуществоФормаОтчета2019(ПараметрыОтчета, Контейнер, ИДРедакцииОтчета);
