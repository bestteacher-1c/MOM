...
Процедура УстановитьВзыскания(Ведомость, ТаблицаВыплат) Экспорт
	...
	ФизлицаДокументы = ТаблицаВыплат.Скопировать(, "ФизическоеЛицо, ДокументОснование");
	ФизлицаДокументы.Свернуть("ФизическоеЛицо, ДокументОснование");
	Взыскания = ИсполнительныеЛисты.УдержанныеСуммыФизическихЛицПоДокументам(ФизлицаДокументы);
