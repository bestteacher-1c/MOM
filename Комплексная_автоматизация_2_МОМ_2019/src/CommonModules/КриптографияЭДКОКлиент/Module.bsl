...
Процедура ВыбратьСертификат(ОповещениеОЗавершении, ЭтоЭлектроннаяПодписьВМоделиСервиса, НачальноеЗначениеВыбора = Неопределено, 
	ХранилищеСертификатов = "MY", ПоказыватьПросроченные = Ложь, МножественныйВыбор = Ложь, Отпечатки = Неопределено, 
	ЗапретитьВыборПросроченных = Ложь, БезВозможностиВыбора = Ложь, ОтпечаткиЗапрещенныхСертификатов = Неопределено) Экспорт
