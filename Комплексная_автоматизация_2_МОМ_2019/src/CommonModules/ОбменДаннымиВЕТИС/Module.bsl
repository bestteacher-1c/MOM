...
//
//Параметры:
//   ДанныеДляОбработки - Массив Из Структура - структуры содержат поля:
//   * ХозяйствующийСубъект - СправочникСсылка.ХозяйствующиеСубъектыВЕТИС - хозяйствующий субъект документов.
//   * Предприятие          - СправочникСсылка.ПредприятияВЕТИС - предприятие документов.
//   * Дата                 - Дата - дата формируемых документов.
//   * ТаблицаЭлементов     - ТаблицаЗначений - Таблица элементов с одной датой изменения.
//   ПараметрыОбмена   - См. ИнтеграцияВЕТИС.ПараметрыОбмена - параметры обмена.
//   ДокументДляВосстановления - Неопределено, Произвольный - документ для восстановления.
//
