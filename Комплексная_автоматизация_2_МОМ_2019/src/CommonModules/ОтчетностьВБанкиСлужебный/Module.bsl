...
Процедура ОтправитьОтчетностьВБанк(Параметры) Экспорт
	...
	// Если все отчеты отправлены, пустой пакет отправлять не требуется
...
Функция ПараметрыЭлектронногоПредставления(Организация, ПараметрыОтчетов, ДатаВыгрузки)
	...
	ПараметрыВыгрузки.Вставить("ВерсФорм", "5.12.04");
...
Функция ПараметрыПредставляемыхОтчетов(Организация, ДатаВыгрузки)
	...
	ПараметрыОтчета = ПараметрыПредставляемыхОтчетов_ОСВПоСчетам(ДатаВыгрузки, ОтправлятьОСВПоСчетам);
...
Функция ПараметрыПредставляемыхОтчетов_ОСВПоСчетам(ДатаВыгрузки, ОтправлятьОтчет)
	...
	ПараметрыОтчета.Вставить("Счета", СчетаОСВПоСчетам());
	ПараметрыОтчета.Вставить("Отправлять", ОтправлятьОтчет);
