...
Функция ТаблицаМаркированныхТоваровСоШтрихкодамиУпаковок(Товары, МаркированныеТовары, ПараметрыУказанияСерий) Экспорт
	...
	Для Каждого СтрокаТовары Из Товары Цикл
		...
		Пока КоличествоСтрокМассиваМаркированныхТоваров >= ТекущаяСтрока Цикл
			...
			СтрокаТоварыРазобранные.СуммаНДС 			= Окр(СтрокаТовары.СуммаНДС / СтрокаТовары.КоличествоЕдиниц, 2);
...
Процедура ТаблицаТоваровСРаспределениемПоИСМП(Товары, ДанныеДляИСМП) Экспорт
	...
	Для Каждого СтрокаТЧ Из Товары Цикл
		...
		Для каждого СтрокаДляДобавленияВТовары Из МассивСтрокДляДобавленияВТовары Цикл
			...
			СтрокаТоваровСРаспределениемПоИСМП.КоличествоУпаковок  = ?(СтрокаДляДобавленияВТовары.КоличествоУпаковок = 0, 1, СтрокаДляДобавленияВТовары.КоличествоУпаковок);
			СтрокаТоваровСРаспределениемПоИСМП.СуммаСНДС = СтрокаДляДобавленияВТовары.СуммаСНДС;
			СтрокаТоваровСРаспределениемПоИСМП.СуммаСкидки = СтрокаДляДобавленияВТовары.СуммаСкидки;
			...
			Если ЭтоМаркированнаяПродукция И ЗначениеЗаполнено(СтрокаДляДобавленияВТовары.Штрихкод) Тогда
				СтрокаТоваровСРаспределениемПоИСМП.Штрихкод = СтрокаДляДобавленияВТовары.Штрихкод;
			КонецЕсли;
