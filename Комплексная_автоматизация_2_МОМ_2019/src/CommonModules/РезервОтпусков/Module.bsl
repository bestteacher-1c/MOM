...
Процедура СобратьДанныеДляНачислениеРезерваОтпусков(Регистратор, Организация, ПериодРегистрации, РасчетРезерваОтпусков, ОценочныеОбязательства, ОценочныеОбязательстваПоСотрудникам) Экспорт
	...
	Если ФормироватьРезервОтпусковБУ Тогда
...
Функция ДоляРезерваОтпусков(Период, Организация, Регистратор = Неопределено)
	...
	ФондОплатыТрудаИВзносы = ТаблицаФондаОплатыТруда.Итог("ФондаОплатыТруда") + ТаблицаФондаОплатыТруда.Итог("СтраховыеВзносы");
	...
	Если ФондОплатыТрудаИВзносы <> 0 Тогда
		...
		ФондОплатыТрудаИВзносыОрганизации  = ТаблицаФондаОплатыТрудаОрганизации.Итог("ФондаОплатыТруда") + ТаблицаФондаОплатыТрудаОрганизации.Итог("СтраховыеВзносы");
