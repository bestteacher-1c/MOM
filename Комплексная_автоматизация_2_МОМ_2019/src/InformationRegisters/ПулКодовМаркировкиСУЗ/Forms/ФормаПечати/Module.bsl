...
Процедура Заполнить(Команда)
	...
	Если Элементы.СтраницыКодыМаркировки.ТекущаяСтраница = Элементы.СтраницаАгрегированныеКодыМаркировки Тогда
		...
		ПараметрыЗаполнения.Вставить("ТаблицаДляЗаполнения", "ДеревоАгрегированныхКодов");
	Иначе
	...
	ОткрытьФорму("РегистрСведений.ПулКодовМаркировкиСУЗ.Форма.ФормаПомощникЗаполненияШаблоновЭтикеток", 
		ПараметрыОткрытияФормы, ЭтаФорма,,,, ОповещениеЗаполнения)
...
Процедура УстановитьУсловноеОформление()
	...
	ОтборОформления.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("ДеревоАгрегированныхКодов.Номенклатура");
