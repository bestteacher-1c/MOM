...
Процедура ПриОткрытии(Отказ)
	...
	Если НЕ ВладелецФормы.ТекущийЭлемент = Неопределено Тогда
		...
		Если НЕ АктивноеПоле = Неопределено Тогда
			...
			РегламентированнаяОтчетностьАЛКОКлиент.ВыполнитьСЗадержкой(ЭтаФорма, "АктивизироватьПоле", 0.2);
...
Процедура АктивизироватьПоле() Экспорт
	...
	Если НЕ ТекущееСостояниеВладельца = "АктивизацияЯчейкиТаблицы" Тогда
