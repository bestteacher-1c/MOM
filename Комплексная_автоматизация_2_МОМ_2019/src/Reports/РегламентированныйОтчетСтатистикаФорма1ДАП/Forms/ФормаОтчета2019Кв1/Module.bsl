...
Функция СравнениеОтчетовНаСервере(ДанныеДляСравнения)
	...
	ИмяМакета = ?(Год(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета) = 2019, "СхемаВыгрузкиXML2019Кв1", "СхемаВыгрузкиXML2020Кв1");
	ДеревоДляСравнения = РегламентированнаяОтчетность.ПолучитьДеревоВыгрузки(ЭтаФорма, ИмяМакета);
...
Функция СформироватьСтруктуруПараметров() Экспорт 
	...
	ИмяМакета = ?(Год(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета) = 2019, "АтрибВыгрузкиXML2019Кв1", "АтрибВыгрузкиXML2020Кв1");
	ДопАтрибуты = РегламентированнаяОтчетность.СформироватьСтруктуруДопАтрибутов(ЭтаФорма.ИмяФормы, ИмяМакета);
...
Функция ПроверитьКонтрольныеСоотношенияИзШаблонаВФоне()
	...
	ИмяМакетаАтр = ?(Год(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета) = 2019, "АтрибВыгрузкиXML2019Кв1", "АтрибВыгрузкиXML2020Кв1");
	ИмяМакетаСхема = ?(Год(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета) = 2019, "СхемаВыгрузкиXML2019Кв1", "СхемаВыгрузкиXML2020Кв1");
	ИмяМакетаШаблон = ?(Год(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета) = 2019, "ШаблонРосстата2019Кв1", "ШаблонРосстата2020Кв1");
	
	ПараметрыПроверкиКонтрольныхСоотношений = Новый Структура;
	ПараметрыПроверкиКонтрольныхСоотношений.Вставить("ШаблонРосстата", ИмяМакетаШаблон);
	ПараметрыПроверкиКонтрольныхСоотношений.Вставить("Атрибуты", ИмяМакетаАтр);
	ПараметрыПроверкиКонтрольныхСоотношений.Вставить("СхемаВыгрузки", ИмяМакетаСхема);
