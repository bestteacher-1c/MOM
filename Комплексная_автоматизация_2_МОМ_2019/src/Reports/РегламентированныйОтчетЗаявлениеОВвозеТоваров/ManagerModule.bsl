...
Функция ТаблицаФормОтчета() Экспорт
	...
	Если ТекущаяДатаСеанса() >= '2020-02-01' Тогда
		
		НоваяФорма = ТаблицаФормОтчета.Добавить();
		НоваяФорма.ФормаОтчета        = "ФормаОтчета2020Кв1";
		НоваяФорма.ОписаниеОтчета     = "Приложение №1 к Протоколу об обмене информацией государств-членов Евразийского экономического союза (с выгрузкой в формате 5.08).";
		НоваяФорма.РедакцияФормы      = "выгрузка в формате 5.08.";
		НоваяФорма.ДатаНачалоДействия = '2005-01-01';
		НоваяФорма.ДатаКонецДействия  = РегламентированнаяОтчетностьКлиентСервер.ПустоеЗначениеТипа(Тип("Дата"));
		
	ИначеЕсли ТекущаяДатаСеанса() >= '2015-01-01' Тогда
	...
	Иначе
		...
		НоваяФорма.ДатаКонецДействия  = '2020-01-31';
		
		НоваяФорма = ТаблицаФормОтчета.Добавить();
		НоваяФорма.ФормаОтчета        = "ФормаОтчета2020Кв1";
		НоваяФорма.ОписаниеОтчета     = "Приложение №1 к Протоколу об обмене информацией государств-членов Евразийского экономического союза (с выгрузкой в формате 5.08).";
		НоваяФорма.РедакцияФормы      = "выгрузка в формате 5.08.";
		НоваяФорма.ДатаНачалоДействия = '2020-02-01';
		НоваяФорма.ДатаКонецДействия  = РегламентированнаяОтчетностьКлиентСервер.ПустоеЗначениеТипа(Тип("Дата"));
