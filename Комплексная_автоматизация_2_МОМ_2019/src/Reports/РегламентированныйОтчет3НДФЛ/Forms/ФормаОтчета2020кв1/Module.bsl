...
Процедура ЗаполнитьМакетМЧБ(Параметры, МакетМЧБ, ОбщиеРеквизитыРазделов)
	...
	Для Каждого Область Из ИсходныйМакет.Области Цикл
		...
		ИначеЕсли Параметры.ИмяСтраницы = "Приложение7" И (Область.Имя = "П000700001032" Или Область.Имя = "П000700001033") Тогда
			
			// Номер объекта или Сведения о местонахождении объекта
			ВывестиМногострочныйТекстОбластиВМакетМЧБ(Область, МакетМЧБ, 7);
			Продолжить;
